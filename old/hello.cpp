...
//    glm::mat4 projection = glm::perspective(glm::radians(45.0f), 4.0f / 3.0f, 0.1f, 100.0f);
    float aaa[16] = {
        2.6625723838806154,0.0,0.0,0.0,
        0.0,1.4976969957351685,0.0,0.0,
        0.005770418327301741,0.001704144524410367,-1.0000100135803223,-1.0,
        0.0,0.0,-0.020000100135803224,0.0
    };
